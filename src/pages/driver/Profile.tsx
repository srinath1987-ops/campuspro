...
import { User, Lock, Phone, AtSign, Save, Truck, Upload } from 'lucide-react';
...
const Profile = () => {
  ...
  if (!profile) {
    return (
      <DashboardLayout title="Driver Profile" role="driver" currentPath="/driver/profile">
              ...
              <CardContent className="space-y-6">
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="flex-1 space-y-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="bus_number">Assigned Bus</Label>
                      <div className="flex">
                        <div className="bg-muted p-2 rounded-l-md flex items-center border border-r-0 border-input">
                        ...
                        <Input
                          id="bus_number"
                          value={profile.bus_number || 'Not assigned'}
                          disabled
                          className="rounded-l-none bg-muted"
                        />
                      </div>
